...
class UserTestCase(unittest.TestCase):
    ...
    def test_change_username(self):
        uuid = user.get_userid(connection, "terry55")
        result = user.change_username(connection, uuid, "uvalencia", "password")
    ...
    def test_change_password(self):
        uuid = user.get_userid(connection, "wrobinson")
    ...
    def test_delete_account(self):
        ...
        uuid = user.get_userid(connection, "christopher61")
