...
class HabitTestCase(unittest.TestCase):
    def test_add_new_habit(self):
        user_random_id = user.get_random_userid(connection)
    ...
    def test_mark_habit_as_completed(self):
        habitid = habit.get_random_habit(connection)
        res = habit.mark_habit_as_completed_tests(connection, habitid,
    ...
    def test_delete_habit(self):
        ...
        deleted = habit.delete_habit(connection, habitid)
        self.assertEqual(deleted, 1)
